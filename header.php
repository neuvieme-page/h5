...
<body <?php body_class(); ?>>
	<script src="/wp-content/themes/h5/assets/js/early.js"></script>
				...
				<div class="imageWrapper hidden">
					...
					if( $posts ):
						...
						foreach( $posts as $post ): 
							...
							<?php }
							else if ($post_title == 'Art' || $post_title == 'Art fr') { ?>
							...
							<?php }	
							else if ($post_title == 'Studio' || $post_title == 'Studio Fr') { ?>
							...
							<?php }	
							else if ($post_title == 'Contact' || $post_title == 'Contact Fr') { ?>
							...
							<?php }							
							else if ($post_title == 'News' || $post_title == 'News fr') { ?>
